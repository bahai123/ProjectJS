	  ...
	  d = {
		init: function(e) {
		  ...
		  return this.each(function() {
			...
			e.wrapAll(function() {
			  return 0 == t(this).parent("#" + s).length ? c : void 0
			});
			var a = e.parent();
			i.center && a.css({
			  width: e.outerWidth(),
  ...
  var global = {
	...
	gTagEvent: function(action, args) {
	  ...
	  if (typeof gtag === "function") {
		...
		$.each(args.items, function(i, o) {
		  items.push({
			id: o.item_id,
			name: o.item_name,
			list_name: args.item_list_name,
			brand: o.item_brand,
			category: (typeof(o.item_category2 != "undefined") ? o.item_category2 : o.item_category),
			variant: o.item_variant,
		...
		switch (action) {
		  ...
		  case "add_shipping_info":
			args = {
			  checkout_step: 2,
			  checkout_option: "shipping_tier",
			  value: args.shipping_tier,
			};
		  ...
		  case "begin_checkout":
			...
			gtag("event", "checkout_progress", args);
			break;
		  case "purchase":
			args = {
	...
	init: function() {
	  ...
	  $("#keyword").on("focus", function() {
		global.ajaxSearch(this);
	  });
	  $("#keyword").on("keyup", global.delay(function() {
		global.ajaxSearch(this);
	  }, 500));
	  // internallink
	  ...
	  $("ul.menu-product.scrollbar>.menu-item").on("mouseleave", function() {
		...
		if (mega && mega.matches(":hover")) {} else {
	  ...
	  global.isMobile(function() {
		$(document).on("click", "#btn-mmenu", function(event) {
		  event.preventDefault();
		  document.body.classList.add("openmenu");
		});
		$(document).on("click", "#icon-menu-mobile-close", function(event) {
		  event.preventDefault();
		  document.body.classList.remove("openmenu");
		});
		$(document).on("click", ".footer-menu .footer-title", function() {
